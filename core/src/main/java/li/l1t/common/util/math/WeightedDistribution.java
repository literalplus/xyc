...
/**
 * Stores a set of values with associated probabilities (relative to the other entries'
 * probabilities) and provides a method to retrieve a random element, respecting these
 * probabilities. Does not support storage of null values.
 *
