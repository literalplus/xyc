...
public interface MapConfig {
    ...
    /**
     * Gets the string-keyed map at given key, or an empty map if there is no value associated with given key. Any
     * values that are not instances of the value type and any keys that are not strings are ignored.
     *
     * @param key       the key to operate on
